angular
.module('populationioApp', [ 'ngRoute', 'duScroll', 'ngResource', 'ui.router', 'ngAnimate', 'ui.bootstrap','ngTouch', 'pascalprecht.translate','popioconfig', 'angular-carousel'])
.config(function ($locationProvider, $urlRouterProvider, $httpProvider, $translateProvider) {
  ...
  if (!isMobile) {
    window.location.href="http://population.io";
  }
