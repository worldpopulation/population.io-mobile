	...
	$.fn.fullpage = function(options) {
		...
		*/
		...
		$('.section').each(function(index){
			...
			if (options.navigation) {
				...
				nav.find('ul').append('<li data-tooltip="' + tooltip + '"><span></span></li>');
			}
		...
		*/		
		...
		$.fn.fullpage.moveTo = function (section, slide){
			...
			// 	scrollPage(destiny);
			// }
			var destiny = $('[data-anchor="'+section+'"]');
			scrollPage(destiny);
		};
		...
		//navigation action 
		$(document).on('click', '#fullPage-nav li', function(e){
			e.preventDefault();
		...
		*/
		...
		function activateNavDots(name, sectionIndex){
			if(options.navigation){
				...
				// }
				$('#fullPage-nav').find('li').eq(sectionIndex).find('span').addClass('active');
			}
		}
